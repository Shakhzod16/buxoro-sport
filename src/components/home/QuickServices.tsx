...
export default function QuickServices() {
  return (
    <div className="services-section" style={{ background: '#EEF3FA', padding: '48px 0' }}>
      <div className="services-inner" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0F2447', marginBottom: '24px' }}>
          Davlat xizmatlari
        </h2>
        <div className="services-grid" style={{ gap: '16px' }}>
          {services.map((s, i) => (
            <a
              key={i}
              href={s.href}
