  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        ...
        <a href="/axborot" style={{ color: '#1A3C6B', fontWeight: 600, textDecoration: 'none', fontSize: '0.9rem' }}>Barchasi →</a>
      </div>
        ...
        {activeNews.map((item) => (
          ...
          >
            <div style={{ background: '#fff', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', transition: 'box-shadow 0.2s' }}>
              <img src={item.image || fallbackImage} alt={item.title} style={{ width: '100%', height: '180px', objectFit: 'cover' }} />
