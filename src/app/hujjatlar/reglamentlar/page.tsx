...
const REGS = [
  { title: "Sport musobaqalarini o‘tkazish va hakamlik faoliyati reglamenti", date: "2024" },
  { title: "Sport unvonlari va razryadlarni berish tartibi bo‘yicha reglament", date: "2023" },
  { title: "Yoshlar o‘rtasida tanlov va festivallarni tashkil etish reglamenti", date: "2025" },
];

export default function ReglamentlarPage() {
  ...
  return (
    <>
      <PageHero
        title="Reglamentlar"
        subtitle="Ichki tartib-qoidalar va metodik hujjatlar"
        breadcrumb={[
          { label: "Hujjatlar", href: "/hujjatlar" },
          { label: "Reglamentlar", href: "/hujjatlar/reglamentlar" },
        ]}
